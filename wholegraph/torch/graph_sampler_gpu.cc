...
static auto registry = torch::RegisterOperators()
    .op("wholememory::unweighted_sample_without_replacement", &whole_graph::pytorch::UnweightedSampleWithoutReplacementCUDA)
    .op("wholememory::unweighted_sample_without_replacement_chunked", &whole_graph::pytorch::UnweightedSampleWithoutReplacementChunkedCUDA)
    .op("wholememory::append_unique", &whole_graph::pytorch::AppendUniqueGPU);

...
template<typename T>
__global__ void MemcpyToWholeChunkedMemoryKernel(WholeChunkedMemoryHandle *wcmh,
                                                 size_t elt_offset,
                                                 const T *src,
                                                 size_t copy_elt_count) {
...
template<typename T>
void DoMemcpyToWholeChunkedMemory(WholeChunkedMemoryHandle *wcmh,
  ...
  MemcpyToWholeChunkedMemoryKernel<<<block_count, kBlockSize, 0, stream>>>(wcmh,
                                                                           base_elt_offset,
                                                                           src_ptr,
                                                                           copy_elt_count);
}
...
template<typename T>
__global__ void MemcpyFromWholeChunkedMemoryKernel(T *dst,
...
template<typename T>
void DoMemcpyFromWholeChunkedMemory(void *dst,
                                    WholeChunkedMemoryHandle *wcmh,
                                    size_t offset_in_bytes,
                                    size_t copy_bytes,
                                    cudaStream_t stream) {
  ...
  MemcpyFromWholeChunkedMemoryKernel<<<block_count, kBlockSize, 0, stream>>>(dst_ptr,
                                                                             wcmh,
                                                                             base_elt_offset,
                                                                             copy_elt_count);
}

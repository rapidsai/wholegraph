...
template<>
inline WMType GetWMType<uint8_t>() { return WMT_Uint8; }
template<>
inline WMType GetWMType<int8_t>() { return WMT_Int8; }
template<>
inline WMType GetWMType<uint16_t>() { return WMT_Uint16; }
template<>
inline WMType GetWMType<int16_t>() { return WMT_Int16; }
template<>
inline WMType GetWMType<uint32_t>() { return WMT_Uint32; }
template<>
inline WMType GetWMType<int32_t>() { return WMT_Int32; }
template<>
inline WMType GetWMType<uint64_t>() { return WMT_Uint64; }
template<>
inline WMType GetWMType<int64_t>() { return WMT_Int64; }
template<>
inline WMType GetWMType<__half>() { return WMT_Half; }
template<>
inline WMType GetWMType<__nv_bfloat16>() { return WMT_Bfloat16; }
template<>
inline WMType GetWMType<float>() { return WMT_Float; }
template<>
inline WMType GetWMType<double>() { return WMT_Double; }
...
#define VEC_HALF_FLOAT_DOUBLE std::vector<whole_graph::WMType>({WMT_Half, WMT_Float, WMT_Double})
#define VEC_ALLFLOAT std::vector<whole_graph::WMType>({WMT_Bfloat16, WMT_Half, WMT_Float, WMT_Double})
...
#define CASES_UINT3264(TEMPFUNC_NAME, ...)    \
  case WMT_Uint32: {                          \
    TEMPFUNC_NAME<uint32_t, ##__VA_ARGS__>(); \
    break;                                    \
  }                                           \
  case WMT_Uint64: {                          \
    TEMPFUNC_NAME<uint64_t, ##__VA_ARGS__>(); \
    break;                                    \
  }

#define CASES_UINT(TEMPFUNC_NAME, ...)        \
  case WMT_Uint8: {                           \
    TEMPFUNC_NAME<uint8_t, ##__VA_ARGS__>();  \
    break;                                    \
  }                                           \
  case WMT_Uint16: {                          \
    TEMPFUNC_NAME<uint16_t, ##__VA_ARGS__>(); \
    break;                                    \
  }                                           \
